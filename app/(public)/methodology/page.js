      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="shine-card bg-gradient-to-br from-gupi-orange-50 to-white rounded-2xl p-6 border border-gupi-orange-200">
                ...
                <p className="text-xs text-gupi-orange-600 font-semibold">الهدف: قياس الانتشار الدولي والاعتراف العالمي — يمثل 70% من الدرجة الإجمالية.</p>
              </div>
              ...
              <div className="shine-card bg-gradient-to-br from-gupi-amber-50 to-white rounded-2xl p-6 border border-gupi-amber-200">
                ...
                <p className="text-xs text-gupi-amber-700 font-semibold">الهدف: قياس التميز والريادة الأكاديمية — يمثل 30% من الدرجة الإجمالية.</p>
              </div>
            </div>
          </section>
        </Reveal>
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-center gap-2.5 flex-wrap">
                ...
                <div className="bg-white text-gupi-orange-900 rounded-xl px-5 py-2.5">
                  <span className="font-display font-black text-lg">100 درجة</span>
                </div>
              </div>
              ...
              <div className="max-w-2xl mx-auto mt-6">
                ...
                <div className="flex justify-between mt-2 text-[11px] font-semibold">
                  <span className="text-gupi-orange-300">الحضور العالمي — 70% (18 درجة)</span>
                  <span className="text-gupi-amber-300">التميز النوعي — 30% (5 درجات)</span>
                </div>
              </div>
            </div>
          </section>
        ...
        <Reveal>
          <section className="bg-white rounded-2xl border border-gupi-ink-100 shadow-sm p-6 md:p-8">
            ...
            <p className="text-gupi-ink-700 text-sm leading-relaxed mb-5">
              يتم ترتيب الجامعات تنازليًا حسب الدرجة النهائية (من 100 درجة). وفي حال تساوي درجات أكثر من جامعة، يتم اللجوء إلى معايير ترجيحية دقيقة حسمًا للترتيب:
            </p>
            <div className="space-y-3">
              {[
        ...
        <Reveal>
          <section className="shine-card bg-gradient-to-br from-gupi-orange-50 to-white rounded-2xl p-6 md:p-8 border border-gupi-orange-100">
            ...
            <p className="text-gupi-ink-700 text-sm leading-relaxed">
              يمثل مؤشر GUPI نموذجًا مستقلًا ومبتكرًا لقياس الحضور العالمي للجامعات العربية، حيث يجمع بين النشاط البحثي والاعتراف الدولي والتميز الأكاديمي ضمن إطار بسيط (100 درجة)، مما يجعله أداة فعالة لصناع القرار والجامعات لتقييم موقعهم عالميًا وتحديد فجوات التحسين. تعتمد التصنيفات في هذا الموقع على بيانات متاحة للعموم، ومؤشرات شفافة، ومنهجيات مطورة بشكل مستقل.
            </p>
          </section>
        </Reveal>
