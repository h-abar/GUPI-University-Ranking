    ...
    <div className="min-h-screen bg-gupi-ink-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-4">
            ما هو مؤشر GUPI؟
          </h2>
          <p className="text-gupi-ink-700 leading-relaxed text-lg">
        ...
        {/* Dimensions */}
        <section>
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-6">أبعاد المؤشر (Index Dimensions)</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-gupi-orange-50 to-white rounded-2xl p-8 border-2 border-gupi-orange-200">
              ...
              <p className="text-sm text-gupi-orange-600 font-medium">الهدف: قياس الانتشار الدولي والاعتراف العالمي.</p>
            </div>
        ...
        {/* Score formula */}
        <section className="bg-gradient-to-br from-gupi-orange-900 to-gupi-orange-950 rounded-2xl p-8 text-white">
        ...
        {/* Sample selection */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-6">منهجية اختيار العينة والتغطية</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              return (
                <div key={i} className="bg-gupi-ink-50 rounded-xl p-5">
                  <Icon className="w-8 h-8 text-gupi-orange-600 mb-3" />
                  <h3 className="font-bold text-gupi-orange-900 mb-2">{item.title}</h3>
        ...
        {/* Main pillars */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-6">الأسس والمعايير الرئيسية</h2>
          <div className="space-y-4">
            {[
              ...
              const Icon = item.icon;
              return (
                <div key={i} className="flex gap-4 bg-gradient-to-l from-gupi-orange-50 to-transparent rounded-xl p-5">
                  <div className="w-12 h-12 rounded-xl bg-gupi-orange-600 text-white flex items-center justify-center flex-shrink-0">
                    <Icon className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gupi-orange-900 mb-1">{item.title}</h3>
                    <p className="text-sm text-gupi-ink-600">{item.desc}</p>
                  </div>
                </div>
              );
        ...
        {/* Algorithm steps */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-6">آلية احتساب المؤشر</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={item.step} className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gupi-orange-500 to-gupi-orange-700 text-white flex items-center justify-center font-display font-black flex-shrink-0">
                  {item.step}
                </div>
                <div className="flex-1 pb-4 border-b border-gupi-ink-100">
                  <h3 className="font-bold text-gupi-orange-900">{item.title}</h3>
                  <p className="text-sm text-gupi-ink-600 mt-1">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-6">نموذج حساب المؤشر المعتمد</h2>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-gupi-ink-50'}>
                    ...
                    <td className="px-4 py-3 text-sm text-gupi-ink-600">{row[1]}</td>
                    <td className="px-4 py-3 text-center text-sm font-medium text-gupi-orange-700">{row[2]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex gap-4 bg-gupi-orange-50 rounded-xl p-4">
                <div className="w-8 h-8 rounded-full bg-gupi-orange-600 text-white flex items-center justify-center font-bold flex-shrink-0">
                  {i + 1}
                </div>
                <div>
                  <h3 className="font-bold text-gupi-orange-900">{item.title}</h3>
        ...
        {/* Key features */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-6">خصائص المؤشر (Key Features)</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="flex items-center gap-3 bg-green-50 rounded-xl p-4">
                ...
                <span className="text-sm font-medium text-gupi-ink-700">{feature}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* Future development */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-6">فرص التطوير المستقبلي</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center gap-3 text-sm text-gupi-ink-700">
                <div className="w-2 h-2 rounded-full bg-gupi-orange-500" />
                {item}
              </div>
            ))}
          </div>
        ...
        {/* Quality assurance */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-display font-bold text-gupi-orange-900 mb-6">إجراءات ضمان الجودة وحدود المنهجية</h2>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-gupi-orange-950 text-white">
              ...
              <tbody>
                <tr className="bg-white">
                  ...
                  <td className="px-4 py-3 text-sm text-gupi-ink-600">
        ...
        <div className="text-center">
          <Link
            href="/rankings"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gupi-orange-600 text-white font-bold text-lg hover:bg-gupi-orange-700 transition-all shadow-xl"
          >
